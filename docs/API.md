# KayStichs API Documentation

## Overview

The KayStichs API provides endpoints for user management, learning modules, rewards, and credential verification. The API follows RESTful principles and returns JSON responses.

**Base URL:** `https://api.kaystichs.io/v1` (production) or `http://localhost:3001/v1` (development)
  ...
  "data": [
    {
      ...
      "language": "en",
      "completions": 1243,
      "thumbnail": "https://cdn.kaystichs.io/modules/stablecoins.jpg"
    }
  ],
  "pagination": {
    "page": 1,
...
```json
{
  ...
  "data": {
    ...
    "content": [
      ...
      {
        "type": "image",
        "url": "https://cdn.kaystichs.io/content/stablecoin-diagram.jpg"
      },
      {
        "type": "quiz",
        "questions": [
...
- Check our [API status page](https://status.kaystichs.io)
