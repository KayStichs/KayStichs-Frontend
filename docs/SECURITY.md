# Security Policy for KayStichs

## Overview

KayStichs is committed to protecting the security and integrity of our platform, users, and community. We take security vulnerabilities seriously and appreciate the efforts of security researchers and community members who help us maintain a safe environment.
...
We currently support the following versions of KayStichs with security updates:
...
- Smart contracts (`https://github.com/kaystichs/contracts/`)
- Backend API (`https://github.com/kaystichs/api/`)
- Frontend application (`https://github.com/kaystichs/kaystichs/`)
...
- Social engineering of KayStichs team members
...
2. **Account Protection**
   - Verify email confirmations come from @kaystichs.io
   - Be cautious of phishing attempts
   - Log out from shared devices
   - Monitor your wallet for unauthorized transactions

3. **Safe Learning**
   - Only access KayStichs through official channels
...
1. **Report Privately**: Send details to security@kaystichs.io first
...
| **Signal**          | @kaystichs.123         | 24/7           |
| **Email**           | emergency@kaystichs.io | Monitored 24/7 |
| **Discord**         | @security-lead (ping)  | Business hours |

For non-emergencies, please use security@kaystichs.io.
...
_Thank you for helping keep KayStichs and our community safe!_ 🛡️
