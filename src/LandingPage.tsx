...
const TESTIMONIALS = [
  { name: "Amara Osei", role: "UX Designer → Product Lead", avatar: "AO", quote: "KayStichs's roadmap felt like having a mentor in my pocket. I went from confused designer to confident PM in eight months.", stars: 5 },
  ...
  return (
    <>
      ...
      <nav className={`nav${scrolled ? " sc" : ""}`}>
        <button className="logo" onClick={() => go("hero")}><span className="ld" /> KayStichs</button>
        <ul className="nl">
      ...
      <section id="hero" className="hero">
        ...
        <p className="hsub">KayStichs turns ambitious goals into structured, joyful learning journeys — powered by AI, guided by mentors, and fuelled by community.</p>
        <div className="hbtns">
      ...
      <section id="features" className="fsec">
        <div className="fhdr">
          <span className="stag">Why KayStichs</span>
