...
export const MOCK_LESSON: Lesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      image: {
        src: "/assets/why-kaystichs/digital-wallet.svg",
    ...
    },
    {
      ...
      image: { src: "/assets/why-kaystichs/earn.svg", alt: "A reward coin" },
      body: [
        "On KayStichs you finish short lessons and quizzes to earn XLM rewards.",
