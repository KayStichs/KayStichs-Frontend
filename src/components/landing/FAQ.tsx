...
const faqData: FAQItem[] = [
  {
    question: "What is KayStichs?",
    answer:
      "KayStichs is a decentralized learn-to-earn platform built on the Stellar blockchain. We help users learn digital skills, earn token rewards for their progress, and receive verifiable on-chain credentials.",
  },
  {
