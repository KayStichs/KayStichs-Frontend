      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#0F172A] sm:text-4xl">
            Why KayStichs is the best way to learn, earn, and grow.
          </h2>
          <p className="mt-5 text-base leading-8 text-[#51607F] sm:text-lg">
            KayStichs combines skills training, blockchain credentials, and rewards in one modern learning platform.
          </p>
        </div>
