...
const TESTIMONIALS = [
  { name: 'Chioma Adeyemi', role: 'Learner · Lagos, Nigeria', avatar: 'CA', avatarBg: '#F97316', quote: "KayStichs helped me upskill in digital marketing and earn money at the same time. I've already referred 5 friends!" },
  ...
  { name: 'Priya Sharma', role: 'Employer · Bangalore, India', avatar: 'PS', avatarBg: '#22C55E', quote: 'We found exceptional talent through KayStichs. The learners are motivated, skilled, and ready to work.' },
]
...
export default function Home() {
  ...
  return (
    <>
      <style href="kaystichs-styles" precedence="default">{`
      ...
      <section id="features" style={{ background: '#F3F4F6', padding: '72px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, color: '#111827', marginBottom: 12, letterSpacing: '-0.5px' }}>Why Choose KayStichs?</h2>
      ...
      <section id="how-it-works" style={{ background: '#fff', padding: '72px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, color: '#111827', marginBottom: 12, letterSpacing: '-0.5px' }}>How KayStichs Works</h2>
      ...
      <section id="testimonials" style={{ background: '#F3F4F6', padding: '72px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ fontSize: 16, color: '#6B7280', margin: 0 }}>Hear from learners and employers who&apos;ve transformed their lives with KayStichs</p>
          </div>
      ...
      <footer style={{ borderTop: '1px solid #E5E7EB', background: '#fff', padding: '24px' }}>
        <div className="footer-inner" style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <span style={{ fontSize: 18, fontWeight: 800, color: '#0070B6' }}>KayStichs</span>
          <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
            {['About', 'Careers', 'Blog', 'Privacy', 'Terms'].map(l => (
              <a key={l} href="#" className="footer-link">{l}</a>
            ))}
          </div>
          <span style={{ fontSize: 12, color: '#D1D5DB' }}>© 2025 KayStichs Inc.</span>
        </div>
      </footer> */}
    </>
  )
