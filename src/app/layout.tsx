...
export const metadata: Metadata = {
  title: {
    default: "KayStichs — Learn & Earn on Stellar",
    template: "%s | KayStichs",
  },
  description:
  ...
  authors: [{ name: "KayStichs Contributors" }],
  creator: "KayStichs",
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_APP_URL ?? "https://kaystichs.app"
  ),
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "/",
    siteName: "KayStichs",
    title: "KayStichs — Learn & Earn on Stellar",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "KayStichs — Learn & Earn on Stellar",
      },
    ],
  },
  twitter: {
